import type { TransactionUnspentOutput, Script, Ed25519KeyHashHex, PolicyId, AssetName, RewardAccount, ProtocolParameters, Datum, Evaluator, Slot, PoolId, NetworkId, Metadata } from "@blaze-cardano/core";
import { AuxiliaryData } from "@blaze-cardano/core";
import { Transaction, Value, TransactionOutput, PlutusData, Address, Ed25519PublicKeyHex, Credential, Ed25519SignatureHex, TransactionWitnessSet } from "@blaze-cardano/core";
import type { IScriptData, SelectionResult, UseCoinSelectionArgs } from "./types";
/**
