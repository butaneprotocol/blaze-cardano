...
[Home](./index.md) &gt; [@blaze-cardano/sdk](./sdk.md) &gt; [applyParamsToScript](./sdk.applyparamstoscript.md)
...
```typescript
declare function applyParamsToScript<T extends TArray>(plutusScript: string, type: T, params: Exact<T>): HexBlob;
```
