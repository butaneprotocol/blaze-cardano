...
`@blaze-cardano/deploy` provides declarative utilities for deploying Cardano
reference scripts with Blaze.
...
- A planner that compares the manifest, cache, and live chain state before
  deciding whether to reuse, deploy, replace, or retire a script reference.
