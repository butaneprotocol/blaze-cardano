...
// @public
export const addressFromCredential: (network: NetworkId, credential: Credential) => Address;

// @public
export const addressFromCredentials: (network: NetworkId, paymentCredential: Credential, delegationCredential?: Credential) => Address;

// @public
export const addressFromValidator: (network: NetworkId, validator: Script) => Address;
...
// @public
export function signMessage(message: HexBlob, privateKey: Ed25519PrivateNormalKeyHex | Ed25519PrivateExtendedKeyHex): Ed25519SignatureHex;
