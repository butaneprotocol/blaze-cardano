...
The command prints the reconciled deployment plan before submission, then writes an updated deployment cache to `SCRIPT_DEPLOYMENT_CACHE` or `./deployment-cache.json`.
